{
  ...
  nist800_53_r4-controls' = l.fromJSON (l.readFile (__inputs__.attack-control-framework-mappings + "/frameworks/attack_10_1/nist800_53_r4/stix/nist800-53-r4-controls.json"));
in {
